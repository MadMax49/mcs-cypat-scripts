#!/bin/bash
clear
echo "MCS Ubuntu Script v3.0 Updated 1/6/2021 at 12:06am EST"
...
echo "- Packages firefox, debsecan, debsums, fail2ban, libpam-tmpdir, libpam-usb, apt-listbugs, apt-listchanges, apt-show-versions, debian-goodies, apparmor, rkhunter, chkrootkit, iptables, portsentry, lynis, ufw, gufw, libpam-cracklib, auditd, tree, clamav, and clamtk installed; coreutils reinstalled" >> ~/Desktop/changelog.log
