...
echo "MCS Ubuntu Script v4.0 Updated 1/8/2021 at 11:04pm EST"
...
file_config () {
	...
	echo "- /etc/login.defs configured (Min days 7, Max days 30, Warn age 14, umask higher perms)" >> ~/Desktop/changelog.log
